Бибилиотека для Arduino, модифицирована для работы с матрицами 64x32 на драйверах 6126A.

This is original Adafruit Arduino library, modified to work with 6126A drivers on 62x32 RGB matrices.
